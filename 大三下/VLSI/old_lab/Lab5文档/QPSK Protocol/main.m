...
%% start simulation
nloop=100000;  % Number of simulation loops
for cnt = 1:length(ebn0)
        ...
        for iii=1:nloop               
              ...
              %% modulation
                [ich1,qch1]=qpskmod(data4,length(data4)/ml);
              ...
              %% demodulation  
                data5=qpskdemod(ich4,qch4,length(ich4));
...
semilogy(ebn0,ber,'--b^',ebn0_theory,ber0_theory,'--ro');
xlabel('Eb/N0');
ylabel('BER');
title('QPSK Rate=2/3 System');
