...
TxRx.Sim.EbN0dB_list = 0: 0.5 :9;

%% -- system configuration
TxRx.Modulation_order = 6; % Modulation scheme: QPSK (2), 16-QAM (4), 64-QAM (6)
...
TxRx.Code.Rate = 3/4; % code rates '1/2', '3/4', '2/3' for IEEE 802.11n
TxRx.Decoder.Algs = {'Hard-Viterbi', 'Soft-Viterbi'}; % 'Hard-Viterbi', 'Soft-Viterbi', 'BCJR', 'myViterbi_c','myViterbi_mt'
...
for d = 1 : length(TxRx.Decoder.Algs)
    figure(1);
    semilogy(0:0.5:9, Result.BER(d, :), 'LineStyle','-', 'Marker','o', 'Color', [d/length(TxRx.Decoder.Algs) 0 d/length(TxRx.Decoder.Algs)],'MarkerSize', 11, 'LineWidth', 2);
    hold on;
