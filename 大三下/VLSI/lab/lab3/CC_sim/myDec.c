/*
 * @Author: [Zhuohao Lee]
 * @Date: 2022-05-23 18:30:50
 * @LastEditors: [Zhuohao Lee]
 * @LastEditTime: 2022-05-28 21:04:53
 * @FilePath:
 * /undefined/Users/edith_lzh/Desktop/大三下/VLSI/lab/lab3/CC_sim/myDec.c
 * /undefined/Users/edith_lzh/Desktop/大三下/VLSI/lab/lab3/CC_sim/myDec.c
 * /undefined/Users/edith_lzh/Desktop/大三下/VLSI/lab/lab3/CC_sim/myDec.c
 * /undefined/Users/edith_lzh/Desktop/大三下/VLSI/lab/lab3/CC_sim/myDec.c
 * /undefined/Users/edith_lzh/Desktop/大三下/VLSI/lab/lab3/CC_sim/myDec.c
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  double *puncturing_pattern;  // puncturing_pattern: for example, [1 1 1 0]
                               ...
                               // bits is dropped
  mxLogical *info_bits_hat;    // a mex data type,
  ...
  for (l = 0; l < 2160; l++) {
    ...
    // begin !
    for (x = 0; x < 64; x++) {
      if (F[x] >= 0) {  // get nextstate/output by input
        ...
        } else if (!puncturing_pattern[2])  // bit rate = 2/3
        {
          switch (output0) {
            case 0:
              if ((l + 1) % 2 ==
                  0)  // puntching method: for even number bit encode, delete
                      // one after it. Only the former one is valid
              {
                transfer[x + nextstate0 * 64] =
        ...
        } else if (!puncturing_pattern[3])  // bit rate = 3/4
        {
          switch (output0) {
            case 0:
              if ((l + 1) % 3 == 2)  // For every 3 bits, the former 2 will be
                                     // deleted due to puntching.
              {
                transfer[x + nextstate0 * 64] =
